const zh = {
    ...
    aiAgentClearChatConfirm: '确定要清空与 AI 助手的全部对话记录吗？此操作不可撤销。',
    aiAgentClearChatTitle: '清空对话',
    aiAgentClearFailed: '清空对话失败',
    aiAgentClose: '关闭',
    aiAgentConfirmSend: '确认发送',
    aiAgentConfirmDelete: '确认删除',
    aiAgentDraftId: '草稿 ID',
    aiAgentEmailId: '邮件 ID',
    aiAgentConfirmSendDesc: '即将发送草稿 #{id}，请确认是否立即发送：',
    aiAgentConfirmDeleteDesc: '即将删除邮件 #{id}，请确认是否继续：',
    aiAgentPermanentWarn: '永久删除 —— 不可恢复。',
    aiAgentCancel: '取消',
    aiAgentViewingEmail: '当前查看',
    aiAgentSummarizeThis: '总结要点',
    aiAgentTodoThis: '提取待办',
    aiAgentReplyThis: '起草回复',
    ...
    aiAgentLoadingDetails: '正在加载详情...',
    aiAgentDraftNotFound: '草稿未找到或已被发送/删除',
    aiAgentEmailNotFound: '邮件未找到或已被删除',
    aiAgentPendingConfirmHint: '请先确认或取消上方待处理的操作...',
    translate: '翻译',
    translateBack: '显示原文',
