const en = {
    ...
    aiAgentClearChatConfirm: 'Are you sure you want to clear all conversation history with the AI agent? This cannot be undone.',
    aiAgentClearChatTitle: 'Clear Chat',
    aiAgentClearFailed: 'Failed to clear chat',
    aiAgentClose: 'Close',
    aiAgentConfirmSend: 'Confirm send',
    aiAgentConfirmDelete: 'Confirm delete',
    aiAgentDraftId: 'Draft ID',
    aiAgentEmailId: 'Email ID',
    aiAgentConfirmSendDesc: 'About to send draft #{id}. Please confirm:',
    aiAgentConfirmDeleteDesc: 'About to delete email #{id}. Please confirm:',
    aiAgentPermanentWarn: 'Permanent — cannot be undone.',
    aiAgentCancel: 'Cancel',
    aiAgentViewingEmail: 'Viewing Email',
    aiAgentSummarizeThis: 'Summarize',
    aiAgentTodoThis: 'Action Items',
    aiAgentReplyThis: 'Reply Draft',
    ...
    aiAgentLoadingDetails: 'Loading details...',
    aiAgentDraftNotFound: 'Draft not found or already sent/deleted',
    aiAgentEmailNotFound: 'Email not found or already deleted',
    aiAgentPendingConfirmHint: 'Please confirm or cancel the pending action above...',
    translate: 'Translate',
